...
class DeeplabDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        jpg_path = "F:/ISLES2017/training_24_image" + '/' + name + ".npy"
...
#         jpg = Image.open(r"/openbayes/input/input0/test_image_224_png" + '/' + name + ".png")
        jpg = np.load(r"F:/ISLES2017/training_24_image" + '/' + name + ".npy")
#         jpg = jpg.convert('L')
...
#     label_path = []
    names = []
    for img,img_path,name in batch:
        images.append(img)
#         pngs.append(png)
...
#     seg_labels = np.array(seg_labels)
    return images,image_path,names